...
from aliens4friends.commons.utils import (archive_checksums, archive_extract,
                                            archive_in_archive_checksums,
                                            archive_in_archive_extract,
                                            io_file_checksum,
                                            is_supported_archive, md5)
...
class AlienMatcher:
    ...
    def fetch_debian_sources(self, package: Package):
        ...
        for line in debian_control['Checksums-Sha1'].split('\n'):
            ...
            if is_supported_archive(elem[2]):
